...
<head>
    ...
    <title>Administratif - School Finance Application </title>
    <!-- icon -->
...
<header>
    ...
    <!-- Navbar -->
    <nav class="navbar fixed-top navbar-expand-lg scrolling-navbar navbar navbar-dark danger-color app-header">
        <div class="container-fluid">

            <!-- Brand -->
            <a class="navbar-brand waves-effect" href="<?php echo base_url() . 'administratif/dashboard'; ?>">
                    ...
                    <?= $this->session->fullname ?>
                        ...
                        <ul class="dropdown-menu settings-menu dropdown-menu-right">
                            <li><a class="dropdown-item"
                                   href="<?= base_url('administratif/vue_profil'); ?>">
                                    Editer profil</a></li>
                            <li><a class="dropdown-item" href="<?= base_url('administratif/logout'); ?>"><i
    ...
    <aside class="position-fixed danger-color app-sidebar" style="color: white">
       ...
       <div class="text-center">
        ...
        <div class="list-group list-group-flush ">
            <a href="<?php echo base_url() . 'administratif/dashboard'; ?>"
               class="danger-color text-light list-group-item  <? if ($active = 'active') ?> list-group-item-action waves-effect <?php echo (uri_string() == 'administratif/dashboard' || uri_string() == 'admin/dashboard') ? "active" : ""; ?>"><i
                        class="fas fa-chart-line"></i> <strong style="color: #ffffff;">Dashboard</strong></a>
           
            <a href=" <?php echo base_url() . 'administratif/inscription'; ?>"
               class="danger-color text-light list-group-item list-group-item-action waves-effect <?php echo (uri_string() == 'administratif/inscription') ? "active" : ""; ?>">
                <i class="far fa-address-card"></i> <strong style="color: #ffffff;">Inscriptions</strong></a>
                 <a href=" <?php echo base_url() . 'administratif/eleve'; ?>"
               class="danger-color text-light list-group-item list-group-item-action waves-effect <?php echo (uri_string() == 'administratif/eleve') ? "active" : ""; ?>">
                <i class="far fa-address-card"></i> <strong style="color: #ffffff;">Elèves</strong></a>
            <a href="<?php echo base_url('administratif/classe'); ?>"
               class="danger-color text-light list-group-item list-group-item-action waves-effect <?php echo (uri_string() == 'administratif/classe') ? "active" : ""; ?>"><i
                        class="fas fa-bezier-curve"></i> <strong style="color: #ffffff;">Classes</strong></a>
            <a href="<?php echo base_url('administratif/section'); ?>"
               class="danger-color text-light list-group-item list-group-item-action waves-effect <?php echo (uri_string() == 'administratif/section') ? "active" : ""; ?>"><i
                        class="fas fa-list-ol"></i> <strong style="color: #ffffff;">Sections</strong></a>
            <a href="<?php echo base_url('administratif/option'); ?>"
               class="danger-color text-light list-group-item list-group-item-action waves-effect <?php echo (uri_string() == 'administratif/agence') ? "active" : ""; ?>"><i
                        class="fas fa-bezier-curve"></i> <strong style="color: #ffffff;">Options</strong></a>

            <a href="<?php echo base_url('administratif/logout'); ?>"
               class="danger-color text-light list-group-item list-group-item-action waves-effect"
        ...
        var myLineChart = new Chart(ctxL, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [<?= $inscriptions_encours[0];?>, <?= $inscriptions_encours[1];?>,<?= $inscriptions_encours[2];?>, <?= $inscriptions_encours[3];?>,
                        <?= $inscriptions_encours[4];?>, <?= $inscriptions_encours[5];?>,<?= $inscriptions_encours[6];?>,<?= $inscriptions_encours[7];?>,
                        <?= $inscriptions_encours[8];?>,<?= $inscriptions_encours[9];?>,<?= $inscriptions_encours[10];?>,<?= $inscriptions_encours[11];?>],
                ...
                },
                    {
                        ...
                        borderColor: [
                            'rgba(0, 10, 130, .7)',
                        ],data: [<?= $inscriptions_traitees[0];?>, <?= $inscriptions_traitees[1];?>,<?= $inscriptions_traitees[2];?>, <?= $inscriptions_traitees[3];?>,
                            <?= $inscriptions_traitees[4];?>, <?= $inscriptions_traitees[5];?>,<?= $inscriptions_traitees[6];?>,<?= $inscriptions_traitees[7];?>,
                            <?= $inscriptions_traitees[8];?>,<?= $inscriptions_traitees[9];?>,<?= $inscriptions_traitees[10];?>,<?= $inscriptions_traitees[11];?>],
