...
<head>
    ...
    <title>RESET PASSWORD - Agile School Management Application</title>
    <!-- icon -->
...
<header>
                    ...
                    <div class="col-md-12">
                        <div class="box box-info">
                            ...
                            <div class="box-body">
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-6">
                                        <label for="" class="control-label"><span class="text-danger">*</span>Votre nom</label>
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="nom_utilisateur"
                                                <?= form_error('nom_utilisateur') ? 'is-invalid' : 'is-valid'; ?>
                                                    value="<?=   $_SESSION['users']; ?>" readonly/>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="" class="control-label"><span class="text-danger">*</span>Ancien Mot de passe</label>
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="anc_mot_pass"
                                                <?= form_error('anc_mot_pass') ? 'is-invalid' : 'is-valid'; ?> value="123456"/>
                                        </div>
                                    </div>
                                </div>
                                <input type="hidden" name="username" value=" <?= $_SESSION['users']; ?>"
                                        required readonly>
                                <input type="hidden" name="username_id" value=" <?= $_SESSION['users_id']; ?>"
                                       readonly>
                                <input type="submit" class="btn btn-outline-danger" value="Appliquer les modifications">
                                <?= form_close(); ?>
                            </div>
                        </div>
                    </div>
    ...
    <footer class="page-footer font-small wow fadeIn bg-danger fixed-bottom">
        <!-- Social icons -->
        <div class="pb-4">
            <!--Copyright-->
