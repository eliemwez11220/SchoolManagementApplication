...
<head>
    ...
    <title> Student - Agile School Management </title>
    <!-- icon -->
...
<header>
    ...
    <nav class="navbar fixed-top navbar-expand-lg scrolling-navbar navbar navbar-dark danger-color-dark app-header">
        <div class="container-fluid">
            ...
            <!-- Brand -->
            <a class="navbar-brand waves-effect" href="<?php echo base_url() . 'eleves/index'; ?>">
                <strong>FLORA School</strong>
            </a>
                ...
                <ul class="navbar-nav nav-flex-icons">
                    ...
                    <?= $this->session->username ?>
                        ...
                        <ul class="dropdown-menu settings-menu dropdown-menu-right">
                            ...
                            <li><a class="dropdown-item" href="<?= base_url('eleve/logout'); ?>"><i
    ...
    <aside class="position-fixed danger-color-dark app-sidebar" style="color: white">
        ...
        <div class="list-group list-group-flush">
            <a href="<?php echo base_url() . 'eleve/index'; ?>"
               class="danger-color-dark text-light list-group-item  <? if ($active = 'active') ?> list-group-item-action waves-effect <?php echo (uri_string() == 'visiteur/index' || uri_string() == 'visiteur/dashboard') ? "active" : ""; ?>"><i
                        class="fa fa-address-card"></i> <strong style="color: #ffffff;">Vue d'ensemble</strong></a>
            <a href=" <?php echo base_url() . 'eleve/dossier_eleve'; ?>"
               class="danger-color-dark text-light list-group-item list-group-item-action waves-effect <?php echo (uri_string() == 'eleve/dossier_eleve') ? "active" : ""; ?>">
                <i class="fa fa-user"></i> <strong style="color: #ffffff;">Mon profil</strong></a>

            <a href=" <?php echo base_url() . 'eleve/parcours_scolaire'; ?>"
               class="danger-color-dark text-light list-group-item list-group-item-action waves-effect <?php echo (uri_string() == 'eleve/parcours_scolaire') ? "active" : ""; ?>">
                <i class="fa fa-user"></i> <strong style="color: #ffffff;">Mon parcours scolaire</strong></a>
            <a href=" <?php echo base_url() . 'eleve/paiement_frais'; ?>"
               class="danger-color-dark text-light list-group-item list-group-item-action waves-effect <?php echo (uri_string() == 'eleve/paiement_frais') ? "active" : ""; ?>">
                <i class="fa fa-user"></i> <strong style="color: #ffffff;">Mes paiements</strong></a>
            <a href=" <?php echo base_url() . 'eleve/inscription_reinscription'; ?>"
               class="danger-color-dark text-light list-group-item list-group-item-action waves-effect <?php echo (uri_string() == 'eleve/inscription_reinscription') ? "active" : ""; ?>">
                <i class="fa fa-user"></i> <strong style="color: #ffffff;">(Ré)inscription</strong></a>
            <a href=" <?php echo base_url() . 'eleve/infos_ecole'; ?>"
               class="danger-color-dark text-light list-group-item list-group-item-action waves-effect <?php echo (uri_string() == 'eleve/infos_ecole') ? "active" : ""; ?>">
                <i class="fa fa-user"></i> <strong style="color: #ffffff;">Infos école</strong></a>
            <a href="<?php echo base_url('eleve/logout'); ?>"
               ...
               onclick="return confirm('Voulez-vous vraiment fermer la session ? notez que toutes les opéations encours seront annulées') ">
                <i class="fas fa-lock"></i> <strong style="color: #ffffff;">Fermer session</strong></a>
        </div>
...
<main class="app-content" role="main">
    <div class="container-fluid mt-4">
        ...
        if (isset($_SESSION['success'])){
            ?>
            <script type="text/javascript">
                alertify.myAlert(<?= $_SESSION['success'] ?>);
            </script>
        <?php
        }elseif (isset($_SESSION['error'])){
        ?>
            <script type="text/javascript">
                alertify.myAlert(<?= $_SESSION['error'] ?>);
            </script>
        <?php
        }
