            ...
            <div class="col-md-12">
                <div class="box box-info">
                        ...
                        <div class="card mb-4 wow fadeIn">
                            ...
                            <div class="card-body d-sm-flex justify-content-between">
                                <h4 class="mb-2 mb-sm-0 pt-1">
                                    <a href="#">Validation demande d'inscription</a>
                                </h4>
                            </div>
                        </div>
                        <!-- Heading -->
                    ...
                    <div class="box-body">
                        ...
                        <form class="" action="<?= base_url() . 'administratif/update_inscription/inscription/' . $inscription['id_inscription']; ?>"
                              method="post">
                            <div class="row clearfix">
                                ...
                                <div class="col-md-4">
                                    <label for="cycle" class="control-label"><span
                                                class="text-danger">*</span>Cycle d'étude</label>
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="cycle"
                                               value="<?= $inscription['cycle'] ? $inscription['cycle'] : set_value('cycle'); ?>"/>
                            ...
                            <input type="submit" class="btn btn-outline-danger" value="Valider l'inscription">
