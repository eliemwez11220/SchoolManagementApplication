                                            ...
                                            foreach ($paiements as $carte) { ?>
                                                <tr>
                                                    ...
                                                    <td class="text-capitalize text-warning">
                                                        <?php if ($carte->statut_paiement == "amorcé"): ?>
                                                             <a class="btn btn-primary text-uppercase btn-rounded btn-sm my-0"
                                       href="<?= site_url('financier/viewPaiement/'.$carte->code_validation); ?>">Completer</a>
                                                        <?php elseif ($carte->statut_paiement == "en attente"): ?>
                                                           

                                            <a class="btn btn-primary text-uppercase btn-rounded btn-sm my-0"
                                       href="<?= site_url('financier/viewPaiement/'.$carte->code_validation); ?>">Valider</a>
                                                           </td>
                                                    <?php endif; ?>
                                                    <td class="text-center">

                                            <a class="btn btn-primary text-uppercase btn-rounded btn-sm my-0"
                                       href="<?= site_url('financier/viewRecu/'.$carte->code_validation); ?>">Recu</a>
                                                    </td>
                                                </tr>
                                            <?php }
                                        } ?>
