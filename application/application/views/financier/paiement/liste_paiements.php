            ...
            <div class="card border-primary">
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <form class="form-inline pull-right" method="post" action="<?= site_url($role_utilisateur.'/list_paiements'); ?>">
                        ...
                        <table class="table table-sm table-striped table-hover">
                            ...
                            <?php $count = 1; foreach ($data['paiements'] as $paiement): ?>
                                <tr class="">
                                    ...
                                    <td class="text-uppercase"><?= $paiement->matricule_eleve; ?></td>
                                    <td class="text-uppercase"><?= $paiement->nom_complet; ?></td>
                                    <td class="text-uppercase"><?= $paiement->type_frais; ?></td>
                                    <td class="text-uppercase">Le <?= utf8_encode(strftime("%d-%m-%Y", strtotime($paiement->date_paiement))) ?></td>
                                    <td class="text-center"><a class="btn btn-outline-primary btn-sm" data-toggle="modal" data-target="#details_paiement<?= $paiement->id; ?>" href="#">Voir plus</a></td>
                                </tr>
                                <div class="modal fade" id="details_paiement<?= $paiement->id; ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <?= form_open('caissier/valider_paiement', '', ['id' => $paiement->id]) ?>
                                            <div class="card-header">
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <h3 class="text-shadow-black text-center">Détail sur le paiement : <small><?= $paiement->code_validation; ?></small></h3>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card-body font-weight-bold">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="matricule_eleve" class="border-bottom-dotted form-control form-control-sm font-weight-bold"
                                                                   value="<?= $paiement->matricule_eleve ?>" readonly>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="type_frais" class="border-bottom-dotted form-control form-control-sm text-capitalize font-weight-bold"
                                                                   value="<?= $paiement->type_frais; ?>" readonly>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <div class="form-group">
                                                            <?php if ($paiement->date_validation != NULL): ?>
                                                                <input type="text" name="date_paiement" class="border-bottom-dotted form-control form-control-sm font-weight-bold"
                                                                       value="Payé le <?= utf8_encode(strftime("%d-%m-%Y", strtotime($paiement->date_paiement))). " et enregistré le ". utf8_encode(strftime("%d-%m-%Y", strtotime($paiement->date_validation))); ?>" readonly>
                                                            <?php else: ?>
                                                                <input type="text" name="date_paiement" class="border-bottom-dotted form-control form-control-sm font-weight-bold"
                                                                       value="Payé le <?= utf8_encode(strftime("%d-%m-%Y", strtotime($paiement->date_paiement))); ?>" readonly>
                                                            <?php endif;?>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="montant_paye">Montant payé</label>
                                                            <input type="text" name="montant_paye" class="border-bottom-dotted form-control form-control-sm font-weight-bold"
                                                                   value="<?= $paiement->montant_paye. " ". $paiement->devise; ?>" readonly>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="montant_complet" class="border-bottom-dotted form-control form-control-sm font-weight-bold"
                                                                   value="<?= $paiement->montant_complet; ?>" readonly>
                                                        </div>
                                            ...
                                            <div class="card-footer">
                                                <?php if($paiement->mode_paiement == "en ligne"):?>
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label>Numéro expéditeur</label>
                                                            <input class="form-control form-control-sm" type="text" name="numero_expediteur" value="<?= $paiement->numero_expediteur?>" readonly>
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Nom expéditeur</label>
                                                            <input class="form-control form-control-sm" type="text" name="nom_expediteur" value="<?= $paiement->nom_expediteur?>" readonly>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control form-control-sm" type="text" name="date_envoi" value="<?= utf8_encode(strftime("%d-%m-%Y %T", strtotime($paiement->date_envoi)))?>" readonly>
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Service mobile</label>
                                                            <input class="form-control form-control-sm" type="text" name="service_mobile" value="<?= $paiement->service_mobile?>" readonly>
                                                        </div>
