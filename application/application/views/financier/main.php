...
<head>
    ...
    <title>Financier - SchoolApp </title>
    <!-- icon -->
...
<header>
    ...
    <nav class="navbar fixed-top navbar-expand-lg scrolling-navbar navbar navbar-dark danger-color app-header">
        <div class="container-fluid">
            ...
            <!-- Brand -->
            <a class="navbar-brand waves-effect" href="<?php echo base_url() . 'financier/dashboard'; ?>">
                    ...
                    <?= $this->session->fullname ?>
                        ...
                        <ul class="dropdown-menu settings-menu dropdown-menu-right">
                            <li><a class="dropdown-item"
                                   href="<?= base_url('financier/vue_profil'); ?>">
                                    Editer profil</a></li>
                            <li><a class="dropdown-item" href="<?= base_url('financier/logout'); ?>"><i
    ...
    <aside class="position-fixed danger-color app-sidebar" style="color: white">
        ...
        <div class="list-group list-group-flush ">
            <a href="<?php echo base_url() . 'financier/dashboard'; ?>"
               class="danger-color text-light list-group-item  <? if ($active = 'active') ?> list-group-item-action waves-effect <?php echo (uri_string() == 'financier/dashboard' || uri_string() == 'admin/dashboard') ? "active" : ""; ?>"><i
                        class="fas fa-chart-line"></i> <strong style="color: #ffffff;">Dashboard</strong></a>
            <a href=" <?php echo base_url() . 'financier/eleve'; ?>"
               class="danger-color text-light list-group-item list-group-item-action waves-effect <?php echo (uri_string() == 'financier/eleve') ? "active" : ""; ?>">
                <i class="far fa-address-card"></i> <strong style="color: #ffffff;">Listes élèves</strong></a>
            <a href=" <?php echo base_url() . 'financier/paiement'; ?>"
               class="danger-color text-light list-group-item list-group-item-action waves-effect <?php echo (uri_string() == 'financier/paiement') ? "active" : ""; ?>">
                <i class="far fa-address-card"></i> <strong style="color: #ffffff;">Paiements</strong></a>
            <a href="<?php echo base_url('financier/logout'); ?>"
...
<footer class="page-footer text-center font-small mt-4  bg-danger">
    ...
    <div class="pb-4">
        ...
        <div class="footer-copyright py-3">
            ...
            <a href="https://www.congoagile.com" target="_blank" class="text-uppercase"> Congo Agile</a>
            ...
            data: {
                ...
                datasets: [{
                    ...
                    },
                    {
                        ...
                        borderColor: [
                            'rgba(255, 200, 200, .2)',
                        ],data: [<?= $paiements_amorces[0];?>, <?= $paiements_amorces[1];?>,<?= $paiements_amorces[2];?>, <?= $paiements_amorces[3];?>,
                            <?= $paiements_amorces[4];?>, <?= $paiements_amorces[5];?>,<?= $paiements_amorces[6];?>,<?= $paiements_amorces[7];?>,
                            <?= $paiements_amorces[8];?>,<?= $paiements_amorces[9];?>,<?= $paiements_amorces[10];?>,<?= $paiements_amorces[11];?>],
                    }
                ]
            },
            options: {
