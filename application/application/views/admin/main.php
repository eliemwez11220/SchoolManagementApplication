       ...
       <div class="text-center">
        ...
        <div class="list-group list-group-flush ">
            <a href="<?php echo base_url() . 'admin/dashboard'; ?>"
               class="danger-color text-light list-group-item  <? if ($active = 'active') ?> list-group-item-action waves-effect <?php echo (uri_string() == 'admin/Dashboard' || uri_string() == 'admin/dashboard') ? "active" : ""; ?>"><i
                        class="fas fa-chart-line"></i> <strong style="color: #ffffff;">Dashboard</strong></a>
            <a href=" <?php echo base_url() . 'admin/agent'; ?>"
               class="danger-color text-light list-group-item list-group-item-action waves-effect <?php echo (uri_string() == 'admin/agent') ? "active" : ""; ?>">
                <i class="far fa-address-card"></i> <strong style="color: #ffffff;">Utilisateurs</strong></a>
