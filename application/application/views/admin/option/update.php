            ...
            <div class="col-md-12">
                <div class="box box-info">
                        ...
                        <div class="card mb-4 wow fadeIn">
                            ...
                            <div class="card-body d-sm-flex justify-content-between">
                                <h4 class="mb-2 mb-sm-0 pt-1">
                                    <a href="#">Modification d'une option</a>
                                </h4>
                            </div>
                        </div>
                        <!-- Heading -->
                    ...
                    <div class="box-body">
                        ...
                        <form class=""
                              action="<?= base_url() . 'admin/update_option/option/' . $option['id_option']; ?>"
                              method="post">
                            <div class="row clearfix">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <input type="text" id="code" class="form-control text-capitalize"
                                               name="nom_option"
                                               value="<?= $option['nom_option'] ? $option['nom_option'] : set_value('nom_option'); ?>"/>
                                        <span class="text-danger"><?php echo form_error('nom_option'); ?></span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label for="section_id" class="control-label"><span class="text-danger">*</span>Section
                                        à laquelle cette option est attachée</label>
                                    <div class="form-group">
                                        <select class="form-control <?= form_error('section_id') ? 'is-invalid' : 'is-valid'; ?>"
                                            ...
                                            <?php foreach ($sections as $section) :
                                                ...
                                                <?php } else {
                                                    if ($section->id_section == $option['id_section']) { ?>
                                                        <option selected id="<?= $section->id_section; ?>"
                                                                value="<?= $section->id_section; ?>"
                                                            <?= set_select('section_id', $section->nom_section); ?>>
                                                            <?= $section->nom_section; ?>
                                                        </option>
                                                    <?php } ?>
                                                    <option value="<?= $section->id_section; ?>"><?= $section->nom_section; ?></option>
                                                    <?php
                                                } endforeach; ?>
                                        </select>
