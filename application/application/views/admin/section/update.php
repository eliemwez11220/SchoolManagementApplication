            ...
            <div class="col-md-12">
                <div class="box box-info">
                        ...
                        <div class="card mb-4 wow fadeIn">
                            ...
                            <div class="card-body d-sm-flex justify-content-between">
                                ...
                                <h4 class="mb-2 mb-sm-0 pt-1">
                                    <a href="#" >Modification d'une section</a>
                                </h4>
                    ...
                    <div class="box-body">
                        ...
                        <form action="<?= base_url(). 'admin/update_section/section/'.$section['id_section']; ?>" method="post">
                          <div class="row clearfix">

                              <div class="col-md-6">
                                  <label for="nom_section" class="control-label"><span class="text-danger">*</span>Nom de la section</label>
                                  <div class="form-group">
                                      <input type="text" id="type" class="form-control text-capitalize" name="nom_section" value="<?= $section['nom_section'] ? $section['nom_section'] : set_value('nom_section') ?>"/>
