                    ...
                    <div class="col-md-8">
                        ...
                        <form class="form-inline" method="post" action="<?= base_url(). 'administratif/eleve' ?>">
                            ...
                            <div class="form-group" style="width: 80%!important;">
                                ...
                                ?>
                                    <input type="submit" class="btn btn-primary btn-sm" name="submit" value="Voir">
                                </div>
                        </form>
                    </div>
                        <div class="col-md-4">
                        <span class="table-add float-right mb-3 mr-2">
                            <a data-toggle="tooltip" data-placement="bottom" title="Cliquer pour ajouter un élève"
                               href="<?php echo base_url() . 'administratif/add_form/eleve/add'; ?>" class="btn btn-primary btn-sm">
                                <i class="fa fa-plus fa-2x" aria-hidden="true"></i>Inscrire nouvel eleve</a></span>
                    </div>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <table id="dtMaterialDesignExample" class="table table-hover table-striped" width="100%">
                        ...
                        foreach ($eleves as $eleve): ?>
                            <tr>
                                ...
                                <td class="text-capitalize"><?= $eleve->statut_eleve; ?></td>

                                <td class="text-center">
                                    <a href="<?= base_url() . "administratif/update_form/eleve/" . $eleve->id_eleve; ?>">
                                        <span class="table-edit" data-toggle="tooltip" data-placement="bottom"
                                              title="Modifier infos élève">
                                            <button type="button" class="btn btn-success btn-rounded btn-sm my-0"><i
                            ...
                            <div class="modal fade" id="details_el<?= $eleve->id_eleve; ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
